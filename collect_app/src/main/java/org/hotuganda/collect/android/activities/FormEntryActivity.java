...
import org.hotuganda.collect.android.adapters.IconMenuListAdapter;
import org.hotuganda.collect.android.adapters.model.IconMenuItem;
import org.hotuganda.collect.android.application.Collect;
import org.hotuganda.collect.android.dao.FormsDao;
import org.hotuganda.collect.android.dao.helpers.ContentResolverHelper;
import org.hotuganda.collect.android.dao.helpers.FormsDaoHelper;
import org.hotuganda.collect.android.dao.helpers.InstancesDaoHelper;
import org.hotuganda.collect.android.exception.GDriveConnectionException;
import org.hotuganda.collect.android.exception.JavaRosaException;
import org.hotuganda.collect.android.external.ExternalDataManager;
import org.hotuganda.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.hotuganda.collect.android.fragments.dialogs.NumberPickerDialog;
import org.hotuganda.collect.android.listeners.AdvanceToNextListener;
import org.hotuganda.collect.android.listeners.FormLoaderListener;
import org.hotuganda.collect.android.listeners.FormSavedListener;
import org.hotuganda.collect.android.listeners.SavePointListener;
import org.hotuganda.collect.android.logic.FormController;
import org.hotuganda.collect.android.logic.FormController.FailedConstraint;
import org.hotuganda.collect.android.logic.FormInfo;
import org.hotuganda.collect.android.preferences.AdminKeys;
import org.hotuganda.collect.android.preferences.AdminSharedPreferences;
import org.hotuganda.collect.android.preferences.GeneralSharedPreferences;
import org.hotuganda.collect.android.preferences.PreferenceKeys;
import org.hotuganda.collect.android.preferences.PreferencesActivity;
import org.hotuganda.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.hotuganda.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.hotuganda.collect.android.tasks.FormLoaderTask;
import org.hotuganda.collect.android.tasks.SaveFormIndexTask;
import org.hotuganda.collect.android.tasks.SavePointTask;
import org.hotuganda.collect.android.tasks.SaveResult;
import org.hotuganda.collect.android.tasks.SaveToDiskTask;
import org.hotuganda.collect.android.utilities.ActivityAvailability;
import org.hotuganda.collect.android.utilities.ApplicationConstants;
import org.hotuganda.collect.android.utilities.DependencyProvider;
import org.hotuganda.collect.android.utilities.DialogUtils;
import org.hotuganda.collect.android.utilities.FileUtils;
import org.hotuganda.collect.android.utilities.FormDefCache;
import org.hotuganda.collect.android.utilities.ImageConverter;
import org.hotuganda.collect.android.utilities.MediaManager;
import org.hotuganda.collect.android.utilities.MediaUtils;
import org.hotuganda.collect.android.utilities.TimerLogger;
import org.hotuganda.collect.android.utilities.ToastUtils;
import org.hotuganda.collect.android.views.ODKView;
import org.hotuganda.collect.android.widgets.DateTimeWidget;
import org.hotuganda.collect.android.widgets.QuestionWidget;
import org.hotuganda.collect.android.widgets.RangeWidget;
import org.hotuganda.collect.android.widgets.StringWidget;
...
import static org.hotuganda.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.hotuganda.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.hotuganda.collect.android.utilities.FormDefCache.writeCacheAsync;
...
public class FormEntryActivity extends AppCompatActivity implements AnimationListener,
    ...
    private void sendSavedBroadcast() {
        sendBroadcast(new Intent("org.hotuganda.collect.android.FormSaved"));
    }
