...
import org.hotuganda.collect.android.dto.Instance;
import org.hotuganda.collect.android.provider.InstanceProviderAPI;
import org.hotuganda.collect.android.tasks.InstanceUploader.Outcome;
import org.hotuganda.collect.android.test.MockedServerTest;
...
import static org.hotuganda.collect.android.test.TestUtils.assertMatches;
import static org.hotuganda.collect.android.test.TestUtils.cleanUpTempFiles;
import static org.hotuganda.collect.android.test.TestUtils.createTempFile;
import static org.hotuganda.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* org.hotuganda.collect.android/.*", r.getHeader("User-Agent"));
